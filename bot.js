...
client.on('message', message => {
        ...
        .setURL(`https://discordapp.com/oauth2/authorize?client_id=470315879620411392&permissions=8&scope=bot`)
...
client.login('NDcwMzE1ODc5NjIwNDExMzky.DjUkIg.OAcSOIQn5SS-a5LTQO4uZeUVZ-8')
